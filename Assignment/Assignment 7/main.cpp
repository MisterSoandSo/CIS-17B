...
int main(int argc, char *argv[])
{
    ...
    QString serverName = "LOCALHOST\\LENOVO-PC\SQLEXPRESS";
    ...
    //QString dsn = QString("DRIVER={SQL Native Client 11.0};SERVER=LOCALHOST\\SQLEXPRESS;DATABASE=test;Trusted_Connection=Yes;");
...
/* Opens the connection to the database, creates a query to send to the database, then displays the information in the console.*/
    if (db.open())
    {
        ...
        qry.bindValue(":id", "4");
        qry.bindValue(":first", "Will");
        qry.bindValue(":last", "Smith");
